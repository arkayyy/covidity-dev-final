...
function DonateMed() {
    ...
    return (
        <div>
            ...
            <div className="med__form" style={{display:"flex",flexDirection:"column"}}>
                ...
                <div className="ques 2" style={{margin:"20px", flexDirection:"column", display:"flex"}}>
                    <span style={style_survey_text}> List down the names of medicines that you wish to donate:</span>
                    <input style={{}}/>
                </div>
                ...
                <button className="buttn1" variant="outline-success" >Donate Now</button>{' '}
