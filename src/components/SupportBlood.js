...
function SupportBlood({countryStates,districts,getCountryStates,getDistricts,getOxygenDonors,oxygenDonors}) {
        ...
        <div >
          ...
          <div className="supportOxygen__body" style={{display:"flex", justifyContent:"space-evenly", flexWrap:"wrap"}}>
            ...
            <div className="ques_wrapper_1" style={{margin:"10px"}}>
                ...
                <div className="ques 2" style={{margin:"20px", flexDirection:"column", display:"flex"}}>
                    <span style={style_survey_text}>What is the blood group of the patient?:</span>
...
const mapStateToProps=(state)=>{
  ...
  export default connect(mapStateToProps,mapDispatchToProps)(SupportBlood)
