...
function SupportMed({countryStates,districts,getCountryStates,getDistricts,getOxygenDonors,oxygenDonors}) {
          ...
          <div className="supportOxygen__body" style={{display:"flex", justifyContent:"space-evenly", flexWrap:"wrap"}}>
            ...
            <div className="ques_wrapper_1" style={{margin:"10px"}}>
                <div className="ques 1" style={{margin:"20px", flexDirection:"column", display:"flex"}}>
                    ...
                    <input pattern="[a-zA-Z]" title="Name should contain only alhabets!"  type="text" value={fullName} onChange={(event)=>{event.preventDefault(); setName((event.target.value).replace(/[^A-Za-z]/ig,''))}} style={{borderRadius: "0.5rem", outline:"none", fontFamily:"Krona One, sans-serif"}}/>
                ...
                <div className="ques 2" style={{margin:"20px", flexDirection:"column", display:"flex"}}>
                    <span style={style_survey_text}>List down the names of medicines that you need:</span>
...
const mapStateToProps=(state)=>{
  ...
  export default connect(mapStateToProps,mapDispatchToProps)(SupportMed)
